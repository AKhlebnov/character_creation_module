"""Модуль представляет собой игру."""
...
def attack(char_name: str, char_class: str) -> str:
    """Атака персонажей с рандомным уроном."""
...
def defence(char_name: str, char_class: str) -> str:
    """Защита персонажей, уровень выбирается рандомно."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Специальные умения разных персонажей."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Приветсвие персонажа и начало тренировки."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Начало игры, приветствие игрока."""
    run_screensaver()
